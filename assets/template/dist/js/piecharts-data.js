	...
	if( $('#e_chart_2').length > 0 ){
		...
		var option1 = {
			...
			series: [
			{
				...
				type:'pie',
				radius : '55%',
				color: ['#00acf0', '#ffbf36', '#f83f37','#8348ad', '#22af47'],
				data:[
				{value:20, name:'Divisi Dakwah'},
				{value:20, name:'Divisi Kominfo'},
				{value:20, name:'Divisi PPM'},
				{value:20, name:'Divisi Kesekretariatan'},
				{value:20, name:'Divisi Dana Usaha'},
				],
				label: {
					normal: {
						formatter: '{b}\n{d}%'
	...
	if( $('#e_chart_12').length > 0 ){
		...
		var option1 = {
			...
			series: [
			{
				...
				color: ['#00acf0', '#ffbf36', '#f83f37','#8348ad', '#22af47'],
				data:[
				{value:25, name:'Divisi Dakwah'},
				{value:25, name:'Divisi Kominfo'},
				{value:25, name:'Divisi PPM'},
				{value:25, name:'Divisi Kesekretariatan'},
				{value:25, name:'Divisi Dana Usaha'},
				],
				label: {
					normal: {
						formatter: '{b}\n{d}%'
