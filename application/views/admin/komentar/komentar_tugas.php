...
<div class="hk-pg-wrapper">
    ...
    <nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent mb-1">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i data-feather='message-circle' class='icons-br-size'></i> Komentar Tugas</li>
        </ol>
    </nav>
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2" name="id_tugas">
                                ...
                                <?php foreach ($tugas as $key) { ?>
                                    <option value="<?= $key->id_tugas; ?>"><?= $key->nama_tugas; ?></option>
                                <?php } ?>
                            </select>
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <h5 class="d-flex align-items-end hk-sec-title mb-1"><i data-feather="message-circle" class="mr-1 icons-header-size"></i> Komentar Tugas</h5>
                    <p class="mb-15">Data Komentar Tugas</p>
                                    ...
                                    <tbody>
                                        ...
                                        <?php $no=1; foreach($komentar as $key){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a onclick="edit(<?= $key->id_komentar; ?>);" class="btn btn-xs btn-icon btn-info text-white" data-toggle="modal" data-target="#modalform"><span class="btn-icon-wrap"><span class="feather-icon"><i data-feather="edit"></i></span></span></a>
    ...
    <script type="text/javascript">
        ...
        function tambah(){
            ...
            document.getElementById('form').action = "<?= base_url('admin/komentar_tugas'); ?>";
        }
