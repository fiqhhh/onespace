		...
		<div class="hk-pg-wrapper hk-auth-wrapper">
			<header class="d-flex justify-content-between align-items-center">
				<a class="d-flex auth-brand" href="#">
					<img class="brand-img" src="<?= base_url('assets/img/logo/rhisad.png'); ?>" width="40px" alt="brand" /> 
				</a>
			</header>
							...
							<div class="fadeOut item auth-cover-img overlay-wrap">
								<div class="auth-cover-info py-xl-0 pt-100 pb-50 bg-blue-custom">
									<div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
										<h1 class="display-3 text-white mb-20">Lorem ipsum dolor sit amet, consectetur adipisicing elit</h1>
									</div>
								</div>
					...
					<div class="col-xl-7 pa-0">
						<div class="auth-form-wrap py-xl-0 py-50">
							<div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
								...
								<form action="<?= base_url('auth/register'); ?>" method="POST" id="formlogin" name="formlogin" autocomplete="off">
									<h1 class="display-4 mb-10 font-weight-bold">Register One Space</h1>
									<p class="mb-30">Created By Muhammad Fiqih Shee Kcil Tamvan.</p>
									...
									<p class="text-center mt-2">Belum Punya Akun? <a href="<?= base_url('auth/'); ?>">Login</a></p>
								</form>
							</div>
						</div>
					</div>
