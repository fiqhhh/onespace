<main class="container px-8 mx-auto">
    ...
    <section class="mt-6">
        <form action="<?= base_url('guru/absen_guru_masuk_proses'); ?>" id="myForm" method="post" autocomplete="off">
            ...
            <div> 
                <div class="w-full h-auto p-4 mt-2 border-2 border-b-8 border-secondary-300 rounded-primary">
                    ...
                    <input class="form-control" id="code_guru" type="hidden" name="nip_guru">
                </div>
            </div>
